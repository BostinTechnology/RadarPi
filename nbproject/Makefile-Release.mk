...
${OBJECTDIR}/common/src/icogLs1Functions.o: common/src/icogLs1Functions.c
	${MKDIR} -p ${OBJECTDIR}/common/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/src/icogLs1Functions.o common/src/icogLs1Functions.c
