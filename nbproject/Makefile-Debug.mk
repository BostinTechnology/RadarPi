...
${OBJECTDIR}/SampleSoftware/src/mainSampleSoftware.o: SampleSoftware/src/mainSampleSoftware.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -ITestProgram -include TestProgram/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SampleSoftware/src/mainSampleSoftware.o SampleSoftware/src/mainSampleSoftware.c
