...
${OBJECTDIR}/AnalogueMeasurement/src/adcFunctions.o: AnalogueMeasurement/src/adcFunctions.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -ITestProgram -include TestProgram/inc -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AnalogueMeasurement/src/adcFunctions.o AnalogueMeasurement/src/adcFunctions.c
